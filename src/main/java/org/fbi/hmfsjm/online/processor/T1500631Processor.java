...
import org.fbi.hmfsjm.online.service.Txn1500631Service;
...
// 即墨房屋维修资金票据使用和作废
public class T1500631Processor extends AbstractTxnProcessor {
    ...
    protected void doRequest(Stdp10ProcessorRequest request, Stdp10ProcessorResponse response) throws ProcessorException, IOException {
        ...
        try {
            new Txn1500631Service().process(branchID, tellerID, vchNo, billNo, vchSts);
